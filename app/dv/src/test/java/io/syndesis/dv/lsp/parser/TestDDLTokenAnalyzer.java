...
public class TestDDLTokenAnalyzer {
    ...
    public void testForeignTable() throws Exception {
        ...
        analyzer.processStatement(STATEMENT_TYPE.CREATE_FOREIGN_TABLE_TYPE);
    ...
    public void testCreateVirtualView() throws Exception {
        ...
        analyzer.processStatement(STATEMENT_TYPE.CREATE_VIRTUAL_VIEW_TYPE);
    ...
    public void testViewName() throws Exception {
        ...
        analyzer.processStatement(STATEMENT_TYPE.CREATE_VIEW_TYPE);
    ...
    @Test
    public void testParensFailure() throws Exception {
        System.out.println(" TEST:  testParensFailure()");
        
        String stmt = "CREATE VIEW winelist( e4 decimal(12,3))) )";
        
        DdlTokenAnalyzer analyzer = new DdlTokenAnalyzer(stmt);
        printTokens(analyzer.getTokens(), "testParensFailure = " + analyzer.getTokens().length);
        
        assertEquals(STATEMENT_TYPE.CREATE_VIEW_TYPE, analyzer.getStatementType());
        
        DdlTokenExceptionInfo result = analyzer.processStatement(STATEMENT_TYPE.CREATE_VIEW_TYPE);
        
        assertEquals(1, result.getExceptions().size());
        assertEquals(14, analyzer.getTokens().length);
        
        for( DdlAnalyzerException ex: result.getExceptions() ) {
