...
export const DdlEditor: React.FunctionComponent<IDdlEditorProps> = props => {
  ...
  const handleEditorDidMount = (valueGetter: any, editor: any) => {
    ...
    console.log('   >>>  DdlEditor  handleEditorDidMount() called....');
    ...
    monaco.languages.registerCompletionItemProvider(LANGUAGE_ID, {
      provideCompletionItems(model, position) {
          ...
          // tslint:disable-next-line:no-console
          console.log('   >>>  DdlEditor  registerCompletionItemProvider() called range = ', range);
          return {
    ...
    // TODO: register to listen for monaco editor cursor/mouse events to get cursor position
  };
  ...
  function createDependencyProposals(range: {
    startLineNumber: number;
      // tslint:disable-next-line:object-literal-sort-keys
      endLineNumber: number; startColumn: number; endColumn: number;
    }) {
      // tslint:disable-next-line:no-console
      console.log('   >>>  DdlEditor  createDependencyProposals() called range = ', range);
    ...
    return [
        ...
        },
        {
            ...
            documentation: "Create View statement including ....",
            insertText: '"CREATE VIEW ${1:name} (\n) AS SELECT * FROM ${2:name};"',
